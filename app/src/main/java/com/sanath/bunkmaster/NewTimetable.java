...
/**
 * Created by Sanath on 26-01-2017.
 */
public class NewTimetable extends AppCompatActivity implements TimetableInterface.whenDone{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.ic_tick:
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(NewTimetable.this);
...
//                                                    "\n" + model.getSubject(), Toast.LENGTH_SHORT).show();
                                        ...
                                        new Handler().postDelayed(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                startActivity(new Intent(NewTimetable.this, Overview.class));
                                                finish();
                                            }
                                        }, 1800);
